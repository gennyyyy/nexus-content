...
const AdvancedWorkspaceView = lazy(() =>
    import("./workspace/AdvancedWorkspaceView").then((module) => ({
        default: module.AdvancedWorkspaceView,
    })),
);
const EasyWorkspaceView = lazy(() =>
    import("./workspace/EasyWorkspaceView").then((module) => ({
        default: module.EasyWorkspaceView,
    })),
);

function WorkspaceViewFallback() {
    return <div className="h-full min-h-[420px] animate-pulse rounded-[28px] bg-zinc-900/60" />;
}
                ...
                <Suspense fallback={<WorkspaceViewFallback />}>
                    {workspace.workspaceMode === "easy" ? (
                        <EasyWorkspaceView
                            ...
                            onArchiveSelectedTask={workspace.handleArchiveSelectedTask}
